...
function World() {
  ...
  let cw = divStage.clientWidth, ch = divStage.clientHeight, scale = 60, x_off = 0, y_off = 0, o_x_off = 0, o_y_off = 0;
  ...
  this.toMouseCoord = (x_c, y_c) => {
    const trace = arr_particles[Math.floor(getRandomArbitary(0, arr_particles.length))];
